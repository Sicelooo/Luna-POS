...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top shadow-sm mb-4">
    <div class="container-fluid px-4">
        <a class="navbar-brand fw-bold" href="dashboard.php">
            <i class="fas fa-store me-2 text-primary"></i>O & Luna POS
        </a>
    ...
    <div class="row g-3 mb-4">
        <div class="col-12">
            <div class="card card-custom bg-white p-4">
                <h6 class="fw-bold text-dark mb-3">Revenue Trend Over Selected Date Range</h6>
        ...
        <div class="col-12">
            <div class="card card-custom bg-white">
                <div class="card-header bg-white py-3 border-0 d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-primary bg-opacity-10 text-primary">Period: <?php echo htmlspecialchars($startDate); ?> to <?php echo htmlspecialchars($endDate); ?></span>
                </div>
