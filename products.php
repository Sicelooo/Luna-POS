        ...
        <div class="card-body">
            <form method="GET" action="products.php" class="row g-3">
                ...
                <div class="col-md-2 d-flex gap-2">
                    ...
                    <a href="products.php" class="btn btn-outline-secondary"><i class="bi bi-x-circle"></i></a>
                </div>
            </form>
        </div>
    </div>
                            ...
                            <?php foreach ($products as $p): ?>
                                <tr>
                                    ...
                                    <td class="text-end fw-semibold <?= $p['SOH'] <= 0 ? 'text-danger' : '' ?>">
                                        <?= number_format($p['SOH'], 2) ?>
                                    </td>
                                    <td class="text-end">$<?= number_format($p['ExclCost'], 2) ?></td>
                                    <td class="text-end fw-bold">$<?= number_format($p['ExclSellPrice'], 2) ?></td>
                                    <td class="text-end">
                                        <span class="badge <?= $p['GPPercentage'] >= 20 ? 'bg-success-subtle text-success' : 'bg-warning-subtle text-warning-emphasis' ?>">
                                            <?= number_format($p['GPPercentage'], 2) ?>%
                                        </span>
                                    </td>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header bg-dark text-white">
        <h5 class="modal-title"><i class="bi bi-pencil-square me-2"></i>Edit Product Details</h5>
